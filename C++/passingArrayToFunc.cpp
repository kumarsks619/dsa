...
void printArray(int *ptr, int n) {  // same as: void printArray(int ptr[], int n)
    for(int i = 0; i < n; i++) {
...
int main() {
    ...
    cout << endl << arr[2];     // arr[2] is converted to *(arr + 2) by the complier.

    return 0;
}

// Arrays are always passed as the address of the first element and recieved in a ptr inside the function.
