...
class Hybrid: public Derived1, public Derived2 {
    ...
    public:
        int getVal() {
            // return val;  without virtual inheritance the val is abiguous here.
...
// To solve the ambiguity in hybrib inheritance, the middle level of inheritance classes need to
