...
public:
    ...
    WithCopyCon(WithCopyCon &obj)
    { // obj to be copied must be passed as ref otherwise it will again
...
int main()
{
    ...
    cout << "value at ptr in nc2 = " << nc2.getVal() << endl
         << endl;
    ...
    cout << "value at ptr in wc2 = " << wc2.getVal() << endl
         << endl;
