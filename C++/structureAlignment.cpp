...
struct Test1 {      // notice th order of data memebers.
    char c1;
    double d1;
    char c2;
};

struct Test2 {      // notice th order of data memebers.
    char c1;
    char c2;
    double d1;
};

struct Test3 {      // notice th order of data memebers.
    char c1;
    double d1;
    char c2;
}__attribute__((packed));   // forcefully compacting the structure alingmnet.
// by compacting an struct alingment, it will take the sum of individual data members sizes.
