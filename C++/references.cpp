...
void fun(const vector<int> &vec) {  // const can also be added if the passed value is not modified inside the function.
    cout << vec[0] << endl;
}
...
int main() {
    ...
    for(auto x : vec1) {    // here x is a copy of each element.
