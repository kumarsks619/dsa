...
{
    for (int i = 0; i < n - 1; i++)
    {                         // loop to do the required number of passes to achieve the sorted array
...
// Bubble sort is a "STABLE algorithm" - the order of occurrence of equal values remain preserved.
