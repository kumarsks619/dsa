...
void merge(int arr[], int l, int m, int u)
{
    ...
    while (i < m - l + 1 && j < u - m)
    {                           // merging arrays based on values
...
// Working principle: ARRAY CONTAINING ONE ELEMENT IS ALREADY A SORTED ARRAY.
// Works as: [SORTED, SORTED]
// Stable Algorithm - the order of occurrence of equal values remain preserved.
// Complex Algorithm
